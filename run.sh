...
FF_PATH="";
TEST_PROFILE="mg1i8xyv.Control";

while getopts r:n:s:b:u:d:me opt; do
  case $opt in
    e)
      TEST_PROFILE="udihpd1p.Test";
      ;;
...
FF_API_URL=$FF_API_URL FF_API_RELATED_DOMAINS=$FF_API_RELATED_DOMAINS FF_API_MERGE=$FF_API_MERGE FF_API_DEPTH=$FF_API_DEPTH FF_API_URL_PER_PAGE=$FF_API_URL_PER_PAGE FF_API_SEC_PER_PAGE=$FF_API_SEC_PER_PAGE timeout 180 $FF_PATH --profile /tmp/$TEST_PROFILE;
